...
const STEPS = [
  { title: "Sube el PDF base", description: "Este es el documento principal donde se insertarán las páginas nuevas." },
  { title: "Sube el PDF a insertar", description: "Todas las páginas de este documento se insertarán dentro del PDF base." },
  { title: "Elige la posición", description: "Indica después de qué página insertar. Usa 0 para insertar al inicio." },
  { title: "Descarga el resultado", description: "Haz clic en 'Procesar y descargar' para obtener el PDF combinado." },
];
...
export default function InsertPage() {
  ...
  return (
    <>
      {showToast && <Toast message="PDF combinado y descargado correctamente." onClose={() => setShowToast(false)} />}
      <ToolLayout steps={STEPS} note="Posición 0 inserta al inicio. Si el PDF base tiene 5 páginas, posición 5 inserta al final.">
        <PageHeader
