...
const STEPS = [
  { title: "Sube las imágenes", description: "Selecciona o arrastra imágenes JPEG o PNG. Máx. 5 MB por imagen." },
  { title: "Revisa el orden", description: "Las imágenes se convierten en páginas en el orden en que aparecen en la lista." },
  { title: "Descarga el PDF", description: "Haz clic en 'Procesar y descargar' para obtener el PDF generado." },
];
...
export default function ImageToPdfPage() {
  ...
  return (
    <>
      {showToast && <Toast message="PDF generado y descargado correctamente." onClose={() => setShowToast(false)} />}
      <ToolLayout steps={STEPS} note="Cada imagen ocupa una página completa. Las dimensiones del PDF coinciden con las de cada imagen original.">
        <PageHeader
          title="Imagen a PDF"
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-5">
          ...
          >
            ...
            <p className="text-xs text-gray-400">JPEG y PNG · máx. 5 MB por imagen</p>
          </div>
