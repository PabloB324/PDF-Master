...
const STEPS = [
  { title: "Sube el PDF", description: "Selecciona el documento que deseas dividir en páginas individuales." },
  { title: "Procesa el archivo", description: "Haz clic en 'Procesar y descargar'. Cada página se convierte en un PDF separado." },
  { title: "Descarga el ZIP", description: "Se descarga automáticamente un archivo ZIP con todos los PDFs individuales." },
];
...
export default function SplitPage() {
  ...
  return (
    <>
      {showToast && <Toast message="ZIP descargado correctamente." onClose={() => setShowToast(false)} />}
      <ToolLayout steps={STEPS} note="Los archivos dentro del ZIP se nombran según el número de página (ej: pagina-01.pdf, pagina-02.pdf…).">
        <PageHeader
          title="Dividir PDF"
