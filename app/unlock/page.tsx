...
export default function UnlockPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    form.append("file", file); form.append("password", password);
    try {
      setProgress(50);
      ...
      <div className="max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="rounded-2xl bg-white p-6 shadow-sm space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Contraseña del PDF</label>
          ...
          <StatusMessage status="info" message="Se eliminará la protección del PDF. Necesitas la contraseña original para continuar." />
